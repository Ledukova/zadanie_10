...
def r(color):
    zpt_pos=0
    c=""
    for i in range(5, len(color)):
        if (color[i]==",") and (zpt_pos==0):
            zpt_pos=i
    for i in range(4, zpt_pos):
        c=c+color[i]
    return int(c)
...
def g(color):
    ...
    for i in range(4, len(color)):
        if (color[i]==",") and (zpt_start==0):
            zpt_start=i
    for i in range(zpt_start+1, len(color)):
...
def b(color):
    ...
    for i in range(4, len(color)):
        if (color[i]==",") and (zpt_1==0):
            zpt_1=i
    for i in range(zpt_1+1, len(color)):
        if (color[i]==",") and (zpt_2==0):
            zpt_2=i
    for i in range(zpt_2+1, len(color)):
